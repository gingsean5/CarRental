...
Partial Class RentalForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.RentalFormToolTip.SetToolTip(Me.NameTextBox, "Your name")
        '
        'AddressTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.AddressTextBox, "Your street address")
        '
        'CityTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.CityTextBox, "City you live in")
        '
        'StateTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.StateTextBox, "State you live in")
        '
        'ZipCodeTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.ZipCodeTextBox, "Zipcode that you live in")
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.BeginOdometerTextBox, "The number on the odometer when you get the car")
        '
        'EndOdometerTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.EndOdometerTextBox, "The number on the odometer when you are done with the car")
        '
        'DaysTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.DaysTextBox, "Number of days you had the car")
        '
        'OdometerGroupbox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.Seniorcheckbox, "Receive a 3% discount")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.AAAcheckbox, "receive a 5% discount")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.CalculateButton, "Checks if you have the required information and calculates how much money you owe" &
        "")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.ClearButton, "Resets the form except for the summary")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.SummaryButton, "View the summary of total costs, miles driven and number of customers")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.TotalMilesTextBox, "Results of the form will be visable once you have filled in all required fields")
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.MileageChargeTextBox, "Results of the form will be visable once you have filled in all required fields")
        '
        'DayChargeTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.DayChargeTextBox, "Results of the form will be visable once you have filled in all required fields")
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.TotalDiscountTextBox, "Results of the form will be visable once you have filled in all required fields")
        '
        'TotalChargeTextBox
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.TotalChargeTextBox, "Results of the form will be visable once you have filled in all required fields")
        '
        'ContextMenuStrip
        '
